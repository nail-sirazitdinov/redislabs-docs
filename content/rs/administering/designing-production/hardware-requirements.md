...
| Ephemeral Storage | Used for storing [replication and export/import files (RDB format)]({{< relref "/rs/administering/designing-production/persistent-ephemeral-storage.md" >}}). | RAM x 2 | >= RAM x 4 |
